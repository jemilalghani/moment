      ...
      <div className="moment-container">
        <div className="moment-card">
          <div className="moment-image">
            <figure class="swap-hover">
              <img  class="swap-hover-front-image" src="http://313ct818yszd3xd6xa2z47nm-wpengine.netdna-ssl.com/wp-content/uploads/2011/11/ChinaPavilion.jpg"/>
              <img class="swap-hover-back-image" src="https://media.timeout.com/images/102875459/630/472/image.jpg"/>
            </figure>
          </div>
